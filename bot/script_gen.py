...
def _gemini_scenes(topic: str, ctx: str):
    ...
    prompt = (
        ...
        f"- Scene 1 = an INSTANT scroll-stopper (4-9 words): a jaw-dropping claim, a 'you've "
        f"been doing this wrong', or a bold question that makes the thumb FREEZE. Front-load "
        f"the single most shocking thing. NO intro, no 'today we'll learn'. Hit instantly.\n"
